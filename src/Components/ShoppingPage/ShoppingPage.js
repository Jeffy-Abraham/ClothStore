  ...
  render() {
    ...
    return (
      ...
      <div className='ShoppingContainer'>
        ...
        <h1 style={{fontFamily:'Tahoma',fontWeight:'500',marginTop:'80px',fontSize:'20px',letterSpacing:'0.2rem'}}>{cloth.Title}</h1>
        <p style={{width:'540px' ,fontSize:'14px',fontFamily:'Raleway',maxWidth:'300px'}}>{cloth.Description} </p>
        <p style={{fontSize:'20px'}}>{cloth.Price}</p>
      
        <p style={{fontSize:'13px',letterSpacing:'0.1rem',display:'inline'}}>COLOR :</p>
       <div style={{width:'23px',height:'23px',backgroundColor:'lightblue',borderRadius:'20px'}}></div>
    
        <select style={{width:'300px',height:'40px',marginTop:'30px'}} name='Size'>
