    ...
    return (
      <div style={{ width: "100%" }}>
        ...
        <div className="DeliveryGrid">
          {this.state.showform == "none" ? (
          ...
          ) : this.state.showform === "showPayment" ? (
            <Spring from={{ opacity: 0 }} to={{ opacity: 1 }}>
              {(props) => (
                <div style={props}>
                  {" "}
            ...
            <div className="AddressForm">
              <h3>
                Your order has been placed .You will receive the item on{" "}
                {date.getDate() + 3}/{date.getMonth()}/2020{" "}
              </h3>
            </div>
          )}
            ...
            <div className="DeliveryBags">
              <div className="DeliveryBags2">
                ...
                {clothCart.map((clothCarts) => {
                  return (
                    <div className="DeliveryBag3">
                      <img
                        src={clothCarts.ImageLink}
                        width="87px"
                        height="116px"
                      />
